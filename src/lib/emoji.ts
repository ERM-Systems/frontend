...
export const emojiGroups: EmojiGroup[] = [
	{
		...
		emojis: [
			...
			{ char: '🫩', name: 'face with bags under eyes' },
	...
	},
	{
		...
		emojis: [
			...
			{ char: '🧏‍♂️', name: 'deaf man' },
			{ char: '🧏‍♀️', name: 'deaf woman' },
			...
			{ char: '🤵‍♂️', name: 'man in tuxedo' },
			{ char: '🤵‍♀️', name: 'woman in tuxedo' },
			{ char: '👰', name: 'person with veil' },
			{ char: '👰‍♂️', name: 'man with veil' },
			{ char: '👰‍♀️', name: 'woman with veil' },
			{ char: '🤰', name: 'pregnant woman' },
			{ char: '🫃', name: 'pregnant man' },
			{ char: '🫄', name: 'pregnant person' },
			{ char: '🤱', name: 'breast-feeding' },
			{ char: '👩‍🍼', name: 'woman feeding baby' },
			{ char: '👨‍🍼', name: 'man feeding baby' },
			...
			{ char: '🧑‍🎄', name: 'Mx Claus' },
			{ char: '🦸', name: 'superhero' },
			{ char: '🦸‍♂️', name: 'man superhero' },
			{ char: '🦸‍♀️', name: 'woman superhero' },
			{ char: '🦹', name: 'supervillain' },
			{ char: '🦹‍♂️', name: 'man supervillain' },
			{ char: '🦹‍♀️', name: 'woman supervillain' },
			{ char: '🧙', name: 'mage' },
			{ char: '🧙‍♂️', name: 'man mage' },
			{ char: '🧙‍♀️', name: 'woman mage' },
			{ char: '🧚', name: 'fairy' },
			{ char: '🧚‍♂️', name: 'man fairy' },
			{ char: '🧚‍♀️', name: 'woman fairy' },
			{ char: '🧛', name: 'vampire' },
			{ char: '🧛‍♂️', name: 'man vampire' },
			{ char: '🧛‍♀️', name: 'woman vampire' },
			{ char: '🧜', name: 'merperson' },
			{ char: '🧜‍♂️', name: 'merman' },
			{ char: '🧜‍♀️', name: 'mermaid' },
			{ char: '🧝', name: 'elf' },
			{ char: '🧝‍♂️', name: 'man elf' },
			{ char: '🧝‍♀️', name: 'woman elf' },
			{ char: '🧞', name: 'genie' },
			...
			{ char: '🚶‍➡️', name: 'person walking facing right' },
			{ char: '🚶‍♀️‍➡️', name: 'woman walking facing right' },
			{ char: '🚶‍♂️‍➡️', name: 'man walking facing right' },
			{ char: '🧍', name: 'person standing' },
			{ char: '🧍‍♂️', name: 'man standing' },
			{ char: '🧍‍♀️', name: 'woman standing' },
			{ char: '🧎', name: 'person kneeling' },
			{ char: '🧎‍♂️', name: 'man kneeling' },
			{ char: '🧎‍♀️', name: 'woman kneeling' },
			{ char: '🧎‍➡️', name: 'person kneeling facing right' },
			{ char: '🧎‍♀️‍➡️', name: 'woman kneeling facing right' },
			{ char: '🧎‍♂️‍➡️', name: 'man kneeling facing right' },
			{ char: '🧑‍🦯', name: 'person with white cane' },
			{ char: '🧑‍🦯‍➡️', name: 'person with white cane facing right' },
			{ char: '👨‍🦯', name: 'man with white cane' },
			{ char: '👨‍🦯‍➡️', name: 'man with white cane facing right' },
			{ char: '👩‍🦯', name: 'woman with white cane' },
			{ char: '👩‍🦯‍➡️', name: 'woman with white cane facing right' },
			{ char: '🧑‍🦼', name: 'person in motorized wheelchair' },
			{ char: '🧑‍🦼‍➡️', name: 'person in motorized wheelchair facing right' },
			{ char: '👨‍🦼', name: 'man in motorized wheelchair' },
			{ char: '👨‍🦼‍➡️', name: 'man in motorized wheelchair facing right' },
			{ char: '👩‍🦼', name: 'woman in motorized wheelchair' },
			{ char: '👩‍🦼‍➡️', name: 'woman in motorized wheelchair facing right' },
			{ char: '🧑‍🦽', name: 'person in manual wheelchair' },
			{ char: '🧑‍🦽‍➡️', name: 'person in manual wheelchair facing right' },
			{ char: '👨‍🦽', name: 'man in manual wheelchair' },
			{ char: '👨‍🦽‍➡️', name: 'man in manual wheelchair facing right' },
			{ char: '👩‍🦽', name: 'woman in manual wheelchair' },
			{ char: '👩‍🦽‍➡️', name: 'woman in manual wheelchair facing right' },
			{ char: '🏃', name: 'person running' },
			{ char: '🏃‍♂️', name: 'man running' },
			{ char: '🏃‍♀️', name: 'woman running' },
			{ char: '🏃‍➡️', name: 'person running facing right' },
			{ char: '🏃‍♀️‍➡️', name: 'woman running facing right' },
			{ char: '🏃‍♂️‍➡️', name: 'man running facing right' },
			...
			{ char: '🧖‍♂️', name: 'man in steamy room' },
			{ char: '🧖‍♀️', name: 'woman in steamy room' },
